...
def test_ui_config_loading():
    ...
    assert ui_config['logo_file'] == '/static/logo.png', "Logo file not loaded correctly"
    assert ui_config['page_title'] == html.escape('Test Title'), "Page title not loaded correctly"
    assert ui_config['contact_text'] == 'test@example.com', "Contact text not loaded correctly"
